...
abstract class HiveMetastoreOnDocker {
  /**
...
abstract class DockerHiveMetastoreIntegrationSuite extends SharedSparkSession with Eventually {

  val db: HiveMetastoreOnDocker
...
@DockerTest
class HMSIntegrationSuite extends DockerHiveMetastoreIntegrationSuite {
  override val db = new HiveMetastoreOnDocker {
